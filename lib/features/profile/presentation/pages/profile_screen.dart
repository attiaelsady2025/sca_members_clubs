            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text(
                    "عضوية رقم: ${profile['membership_id'] ?? 'غير متوفر'}",
                    style: GoogleFonts.cairo(
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        _buildSection([
                          _buildProfileItem(context, Icons.family_restroom, "أفراد الأسرة", () {
                            Navigator.pushNamed(context, '/family_members');
                          }),
                           _buildProfileItem(context, Icons.history, "سجل النشاطات", () {
                        ...
                        _buildSection([
                          _buildProfileItem(context, Icons.settings, "الإعدادات", () {
                            Navigator.pushNamed(context, '/settings');
                          }),
                           _buildProfileItem(context, Icons.lock, "تغيير كلمة المرور", () {
                             Navigator.pushNamed(context, '/change_password');
                           }),
                          _buildProfileItem(context, Icons.language, "اللغة", () {
                             Navigator.pushNamed(context, '/settings');
                          }),
                        ]),
                        ...
                        _buildSection([
                           _buildProfileItem(context, Icons.help, "المساعدة والدعم", () {
  ...
  Widget _buildProfileItem(
    ...
    return Column(
      children: [
        ...
        if (showDivider)
          Padding(
            padding: const EdgeInsets.only(right: 60), // Indent divider to align with text
